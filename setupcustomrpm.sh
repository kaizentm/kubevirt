...
export DOCKER_TAG=1.6.0-l1vh.141
export KUBEVIRT_PROVIDER=external
export KUBECONFIG=/etc/rancher/k3s/k3s.yaml

export CUSTOM_LIBVIRT_IMAGE=ghcr.io/kaizentm/kubevirt/libvirt-rpms:qemu-mshv
export CUSTOM_QEMU_IMAGE=ghcr.io/kaizentm/kubevirt/qemu-rpms:qemu-mshv

set -euo pipefail
echo "Setting up custom libvirt & qemu RPM repos..."

# Pull pre-built RPM images
docker pull $CUSTOM_LIBVIRT_IMAGE
docker pull $CUSTOM_QEMU_IMAGE
