...
Name: qemu-kvm
Version: 10.1.0
Release: 100%{?rcrel}%{?dist}%{?cc_suffix}
...
Patch77: revert-overlapping-mem-mappings.patch
...
Install this package if you want access to the qemu tests or qemu-iotests.
