...
func (k *MshvVirtRuntime) HandleHousekeeping(vmi *v1.VirtualMachineInstance, cgroupManager cgroup.Manager, domain *api.Domain) error {
...
func (k *MshvVirtRuntime) GetQEMUProcess(podIsoDetector isolation.PodIsolationDetector, vmi *v1.VirtualMachineInstance) (ps.Process, error) {
...
func (k *MshvVirtRuntime) GetVirtqemudProcess(podIsoDetector isolation.PodIsolationDetector, vmi *v1.VirtualMachineInstance) (ps.Process, error) {
	res, err := podIsoDetector.Detect(vmi)
	if err != nil {
		return nil, err
	}
...
func (k *MshvVirtRuntime) adjustQemuProcessMemoryLimits(podIsoDetector isolation.PodIsolationDetector, vmi *v1.VirtualMachineInstance, additionalOverheadRatio *string) error {
...
func (k *MshvVirtRuntime) AdjustResources(podIsoDetector isolation.PodIsolationDetector, vmi *v1.VirtualMachineInstance, config *v1.KubeVirtConfiguration) error {
...
func (k *MshvVirtRuntime) configureHousekeepingCgroup(vmi *v1.VirtualMachineInstance, cgroupManager cgroup.Manager, domain *api.Domain) error {
...
func (k *MshvVirtRuntime) configureVCPUScheduler(vmi *v1.VirtualMachineInstance) error {
...
func (k *MshvVirtRuntime) MshvPitPid(vmi *v1.VirtualMachineInstance) (int, error) {
	qemuprocess, err := k.GetQEMUProcess(k.podIsolationDetector, vmi)
	if err != nil {
		return -1, err
	}
...
func (k *MshvVirtRuntime) affinePitThread(vmi *v1.VirtualMachineInstance) error {
...
func isVCPU(comm []byte) (string, bool) {
	if !mshvVcpuRegex.MatchString(string(comm)) {
		return "", false
	}
	v := mshvVcpuRegex.FindSubmatch(comm)
