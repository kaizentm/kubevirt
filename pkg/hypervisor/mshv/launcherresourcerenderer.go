...
type MshvLauncherResourceRenderer struct{}

func NewMshvLauncherResourceRenderer() *MshvLauncherResourceRenderer {
	return &MshvLauncherResourceRenderer{}
}

func (k *MshvLauncherResourceRenderer) GetHypervisorDevice() string {
	return "mshv"
}

func (k *MshvLauncherResourceRenderer) GetVirtType() string {
	return "hyperv"
}

func (k *MshvLauncherResourceRenderer) GetHypervisorDeviceMinorNumber() int64 {
	return 125
}
...
func (k *MshvLauncherResourceRenderer) GetMemoryOverhead(vmi *v1.VirtualMachineInstance, cpuArch string, additionalOverheadRatio *string) resource.Quantity {
	// KVM specific memory overhead calculation implementation
