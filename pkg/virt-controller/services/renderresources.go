...
func getRequiredResources(vmi *v1.VirtualMachineInstance, hypervisorDeviceK8sResource string, allowEmulation bool) k8sv1.ResourceList {
	...
	if !allowEmulation {
		res[k8sv1.ResourceName(hypervisorDeviceK8sResource)] = resource.MustParse("1")
	}
