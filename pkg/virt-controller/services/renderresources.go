...
func getRequiredResources(vmi *v1.VirtualMachineInstance, allowEmulation bool, hvCtx *hypervisor.HypervisorContext) k8sv1.ResourceList {
	...
	if !allowEmulation {
		res[hvCtx.K8sResourceName()] = resource.MustParse("1")
	}
